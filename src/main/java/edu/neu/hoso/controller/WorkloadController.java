...
public class WorkloadController {
    ...
    public ResultDTO<List<WorkloadItem>> DepartmentsWorkload(String sdate, String edate) {
        ...
        for (Department department : departmentService.getAllDepartment()){
            WorkloadItem tempWorkloadlist = DepartmentWorkload(sdate,edate,department.getDepartmentId()).getData();
    ...
    public ResultDTO<List<WorkloadItem>> DoctorsWorkload(String sdate, String edate,int departmentID) {
        Date startdate = dateConverter.convert(sdate);
        Date enddate = dateConverter.convert(edate);
        //1 临床 2 医技 3 财务 4 行政 5 其他
        ResultDTO resultDTO = new ResultDTO<List<WorkloadItem>>();
        ...
        for (User doctor: userService.getUserByDepartmentID(departmentID)){
            WorkloadItem tempWorkloadlist = PersonalWorkload(sdate,edate,doctor.getUserId()).getData();
    ...
    public ResultDTO<WorkloadItem> DepartmentWorkload(String sdate, String edate, int departmentID) {
        Date startdate = dateConverter.convert(sdate);
        Date enddate = dateConverter.convert(edate);
        //1 临床 2 医技 3 财务 4 行政 5 其他
    ...
    public ResultDTO<WorkloadItem> PersonalWorkload(String sdate, String edate, int doctorID) {
        //1 临床 2 医技 3 财务 4 行政 5 其他
        Date startdate = dateConverter.convert(sdate);
        Date enddate = dateConverter.convert(edate);
        ResultDTO resultDTO = new ResultDTO<WorkloadItem>();
