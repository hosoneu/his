...
public class DoctorRegistrationServiceImpl implements DoctorRegistrationService {
     ...
     * @description: 列出个人患者挂号列表（自己正在处理的挂号、挂号到自己但别人在处理且别人已下线）
     * @author: 29-y
     ...
     * @description: 列出科室患者挂号列表（无人正在处理的挂号、病历的处理人已经下线且挂号到的医生也已经下线）
     * @author: 29-y
     * @date: 2019-06-17 9:59
     * @param: [userId]
     * @return: java.util.List<edu.neu.hoso.model.Registration>
     ...
     * @description: 在个人挂号列表中切换患者 如果没有初诊 需要将当前医生挂号限额-1 原医生挂号限额+1
     * @author: 29-y
     * @date: 2019-06-17 9:59
